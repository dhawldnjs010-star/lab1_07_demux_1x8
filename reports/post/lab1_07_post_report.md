...
| 설계 top | `demux_1x8` (Design Sources) |
| 시뮬레이션 top | `tb_demux_1x8` (`sim/tb_demux_1x8.sv`) |
| 핀 제약 | `constraints/pins.xdc`, IOSTANDARD LVCMOS33 |
| 소스 커밋 | `7d89e2b` — https://github.com/dhawldnjs010-star/lab1_07_demux_1x8/commit/7d89e2bb86940d3a26fb05ab34fb946173bf776d |
| Vivado 프로젝트 | 없음 |

## 2. VS Code(Icarus)와 Vivado 시뮬레이션 비교

두 실행은 같은 RTL과 같은 자기검사 TB(`tb_demux_1x8`)를 사용했다.

| 비교 항목 | VS Code (Icarus) | Vivado (xsim) |
|---|---|---|
| PASS 문구 | `LAB1_PASS demux_1x8 cases=16` | 미수행 |
| 검사 수 | 16개 | - |
| 종료 시각 | 160 ns | - |
